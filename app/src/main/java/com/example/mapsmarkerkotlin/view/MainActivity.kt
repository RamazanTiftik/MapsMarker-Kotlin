...
import com.example.mapsmarkerkotlin.adapter.PlaceAdapter
import com.example.mapsmarkerkotlin.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val db= Room.databaseBuilder(this,PlaceDatabase::class.java,"Places").build()
